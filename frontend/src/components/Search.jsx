    ...
    <div className="min-h-screen bg-gradient-to-b from-[#303841] to-[#1a1e24] p-8">
      <div className="max-w-7xl mx-auto mt-20">
        ...
        <div className="mb-12 text-center">
          ...
          {query && (
            <p className="mt-6 text-white/80 text-lg font-[circular-web]">
              Showing results for:{" "}
              <span className="font-semibold text-[#fbf2c8]">{query}</span>
            </p>
          )}
        </div>
          ...
          <div className="text-center py-20">
            <div className="inline-block p-8 bg-white/5 rounded-2xl">
              ...
              <p className="text-white/70 max-w-md mx-auto">
                We couldn't find any matches. Try different keywords or explore trending movies.
              </p>
            </div>
          </div>
        ) : (
